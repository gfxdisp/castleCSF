...
%             end
    ...
    methods( Static )
        ...
        function p = get_default_par()
            ...
            p.ach_sust.S_max = [ 44.4763 0.713964 0.277857 7.54866e-07 8.50217e+09 ];
			p.ach_sust.f_max = [ 1.55909 103.604 0.251815 ];
			p.ach_sust.bw = 0.177674;
			p.ach_sust.a = 1.74265e-102;
			p.ach_trans.S_max = [ 0.411266 211.504 ];
			p.ach_trans.f_max = 0.00115423;
			p.ach_trans.bw = 2.52628;
			p.ach_trans.a = 0.000273289;
			p.sigma_trans = 0.156257;
			p.sigma_sust = 15.8409;
			p.ecc_drop = 0.0277526;
			p.ecc_drop_nasal = 0.0275591;
			p.ecc_drop_f = 0.0175072;
			p.ecc_drop_f_nasal = 0.00987064;
