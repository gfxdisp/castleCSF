...
%             end
        ...
        function [R_sust, R_trans] = get_sust_trans_resp(obj, omega, ecc)
        ...
        function plot_mechanism( obj, plt_id )
            switch( plt_id )
                case 'sust_trans' % sust-trans-response
                    ...
                    [R_sust, R_trans] = obj.get_sust_trans_resp(omega,0);
                ...
                case { 'peak_s' }
                    ...
                    for pp=1:length(OMEGAs)
                        ...
                        hh(pp) = plot( L, S_max, 'Color', COLORs(pp,:), 'DisplayName', sprintf('%g Hz', OMEGAs(pp)), 'LineWidth', 2);
                        hold on
                    end
