classdef CSF_stelaCSF_lum_peak < CSF_base
    ...
    methods
        ...
        function S = sensitivity( obj, csf_pars )
            ...
            [R_sust, R_trans] = get_sust_trans_resp(obj, omega, lum);
...
%             end
        ...
        function S = csf_achrom( obj, freq, area, lum, ecc, ach_pars )
            ...
            % Equation on the page 2784, one after (25)
             ...
             if isfield( ach_pars, 'f_0' )
                f0 = ach_pars.f_0;
            else
                f0 = 0.65;
            end
            if isfield( ach_pars, 'A_0' )
                A0 = ach_pars.A_0;
            else
                A0 = 270;
            end
